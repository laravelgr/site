...
<div class="container mx-auto">
    ...
    <div class="flex justify-center socials text-center p-5">
...
<div class="flex text-center mt-20 p-10 bg-blue-100">
    <div class="flex-1 text-blue-800">
        ...
        <button class="ml-6 bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded">
            Εγγραφή
        </button>
    </div>
</div>
